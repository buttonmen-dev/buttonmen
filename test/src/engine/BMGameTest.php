...
//        $this->object->roundScoreArray = array(40, -25);
    ...
    public function test_value_round() {
        ...
        $this->assertEquals(array('scoreValue', 'capture'),
                            array_keys($button1->dieArray[0]->hookList));
