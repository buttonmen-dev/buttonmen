 ...
 */
class BMGameTest extends PHPUnit\Framework\TestCase {
	...
	// FIXME: the right thing to do here is to take the excuse to DTRT
	// and specify the values everywhere that wants them, but the reason
	// this is breaking now is because of changes in phpunit's
	// default behavior around resetting global variables between tests
        global $BM_RAND_REQUIRE_OVERRIDE;
