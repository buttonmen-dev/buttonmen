...
require_once "../test/src/engine/TestDummyBMSkillCaptureCatcher.php";
require_once "../test/src/engine/TestDummyBMSkillRollCatcher.php";
require_once "../test/src/engine/TestDummyBMAttTesting.php";
...
class BMAttackTest extends PHPUnit_Framework_TestCase {
    ...
    public function testFind_attack()
    {
        ...
        $this->assertFalse($att->find_attack(new TestDummyGame));
    }
