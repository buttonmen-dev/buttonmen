...
UPDATE button SET flavor_text="Rikachu is a bootleg button men created at Origins. He's a Pokedog - from the Pokeman ad opposite the Tess page." WHERE name="Rikachu";
UPDATE button SET flavor_text="ConMan plays games at conventions until (and sometimes past) dawn, drinks coffee like it's water, and he likes to beat people up." WHERE name="ConMan";
...
UPDATE button SET flavor_text="Morgan knows the rules. She never does anything without reason, and she loves to beat people up." WHERE name="Morgan";
...
UPDATE button SET flavor_text="This warrior diety of the ancient Aztec religion enjoys playing ping-pong, being worshipped, and beating people up." WHERE name="Huitzilopochtli";
...
UPDATE button SET flavor_text="Bane needlessly worries about things he can never change. He likes the cowboys, empty paint cans, and beating people up." WHERE name="Bane";
UPDATE button SET flavor_text="Bluff can not be described by flippant sound bite. She likes Crusher, bobsled racing, and beating people up." WHERE name="Bluff";
...
UPDATE button SET flavor_text="Peace lives in the exile on the island of St Helena, where she enjoys swing dance, solitaire, and beating people up." WHERE name="Peace";
UPDATE button SET flavor_text="Reaver takes unparalelled pleasure in bringing joy to her fellow beings. She onjoys surprise gift giving, platonic love, and beating people up." WHERE name="Reaver";
...
UPDATE button SET flavor_text="Before becoming the Akami Professor of Internet Mathematics at UC San Diego, Dr. Fan Chung Graham directed math research labs at Bellcore. She and her husband Ron developed semi-random routing theories that keep the Internet running." WHERE name="Fan Chung Graham";
...
UPDATE button SET flavor_text="GAWAINE. The king's loyal nephew, he fights with the strength of three men." WHERE name="Gawaine";
UPDATE button SET flavor_text="GUENEVER. The Queen of the Court of Love, torn between her husband and her lover." WHERE name="Guenever";
UPDATE button SET flavor_text="ARTHUR. King of the Britons, the embodiment of Glory and Honor, and betrayed husband." WHERE name="King Arthur";
UPDATE button SET flavor_text="LANCELOT. The best knight in the world, torn between his love for the queen and duty to his king." WHERE name="Lancelot";
UPDATE button SET flavor_text="MERLIN. The great magician who advises the king, but who always has his own agenda." WHERE name="Merlin";
UPDATE button SET flavor_text="MORDRED. The king's bastard son, he has had villainy thrust upon him and revels in it." WHERE name="Mordred";
UPDATE button SET flavor_text="MORGAN Le FAY. The dark enchantress who beguiles all with mysterious faerie magic." WHERE name="Morgan Le Fay";
UPDATE button SET flavor_text="NIMUE. The lady of the Lake, she holds the powers of Excalibur and Avalon." WHERE name="Nimue";
UPDATE button SET flavor_text="Bill sells \"items\" and \"objects\" at a game store of which he is the proprietor. His many powers include \"discounting\" and \"print advertising\" and he likes to beat people up. (Iago)" WHERE name="Bill";
UPDATE button SET flavor_text="Carson is muskrat whose secret origions are steeped in mystery. He enjoys mopping, the floor, all day, and he likes to beat people up. (Kublai)" WHERE name="Carson";
UPDATE button SET flavor_text="Gilly is a perky goth who likes to play games. She enjoys just about everything, just about everything else, and beating people up. (Clare)" WHERE name="Gilly";
UPDATE button SET flavor_text="Igor is a viscious, sweaty man with a garbage can on his head. He likes long walks in the park, red rhubarb jelly and beating people up. (Hammer)" WHERE name="Igor";
UPDATE button SET flavor_text="Ken is a hard-riding hobbyist with a heart of gold. He likes frivolity, jumping up and down, running with his tongue hanging out, and beating people up. (Bauer)" WHERE name="Ken";
UPDATE button SET flavor_text="Matt is as loveable as the day is long. Just look at that cute widdow nose. He likes role-playing, the unexpected, and beating people up. (Hannah)" WHERE name="Matt";
...
UPDATE button SET flavor_text="Cesare is the banished heir to the throne of a large kingdom. He likes plotting revenge, procrastinating people, and beating people up." WHERE name="Cesare";
...
UPDATE button SET flavor_text="Farrell spends his weekends by the seaside, watching re-runs and knitting sweaters. But during the week, he llikes to beat people up." WHERE name="Farrell";
...
UPDATE button SET flavor_text="Mischa is a tracker whose well-honed nature skills often leads her to the mall. She likes culottes, vegetarian pizza, and beating people up." WHERE name="Mischa";
UPDATE button SET flavor_text="When Nightmare loses a round, he may alter his opponent's variable dice instead of his own." WHERE name="Nightmare";
...
UPDATE button SET flavor_text="Vincent has the cunning of a fox and table manners of a six-year old boy. He likes tofu, library paste, and beating people up." WHERE name="Vincent";
...
UPDATE button SET flavor_text="Spells and mystic zaps are what Artax do best. His two best words of power are Abracadabra and beatpeopleup." WHERE name="Artax";
...
UPDATE button SET flavor_text="A twisted scientist and prectitioner of Pre-Colombian Neurosurgery, the good Doctor would love to beat people up, but his plans never come out as planned." WHERE name="Dr. Speculo";
...
UPDATE button SET flavor_text="Jedite is the first Negaverse Generel, who was sent to the Earth to harvest energy from humans. Jedite likes taking advantage of gullible humans, wearing cool disguises, and trying to take over the world." WHERE name="Jedite";
UPDATE button SET flavor_text="Malachite is the fourth negaverse Generel, who was sent to Earth to reveal Sailor Moon's identity. malachite likes taunting the Scouts, arguing with Prince Darien, and trying to take over the world." WHERE name="Malachite";
...
UPDATE button SET flavor_text="Queen Beryl is the vicious ruler of the Negaverse, and the loyal servant of the Negaforce. Beryl likes controlling jer monster servants, seeking revenge on her enemies, and trying to take over the world." WHERE name="Queen Beryl";
...
UPDATE button SET flavor_text="Zoycite is the third Negaverse General, who was sent to Earth to collect the seven Rainbow Crystals. Zoycite likes spoiling Nephelite's plans, hugging Malachite, and trying to take over the world." WHERE name="Zoycite";
...
UPDATE button SET flavor_text="Princess Serena is the alter ego of Sailor Moon who was first born on the Moon during the Silver Millenium. Princess Serena likes dancing with Prince Darien, blasting enemies with her wand, and saving the universe from destruction." WHERE name="Princess Serena";
UPDATE button SET flavor_text="Queen Serenity is the kind and gentle ruler that held court during the Silver Milennium one thousand years ago. Queen Serenity likes beautiful dresses, capturing Shadow Warriors and saving the universe from destruction." WHERE name="Queen Serenity";
UPDATE button SET flavor_text="Rini is a sucy, young, pink-haired child who will someday be the Queen of the Universe. Rini likes eating ice-cream and other goodies, playing with her mommy's shiny crystals, and saving the universe from destruction." WHERE name="Rini";
...
UPDATE button SET flavor_text="Aylee thinks she looks like a pretty flower. She attended cannibals annonymous, and she likes to eat people up." WHERE name="Aylee";
...
UPDATE button SET flavor_text="Riff is a freelance inventor whose desire to build nifty toys is exceeded only by his joy in building big guns (which some times beat people up)." WHERE name="Riff";
UPDATE button SET flavor_text="Torg is a freelance webpage designer. He makes occasional trips to alternate dimensions or past history, where he sometimes beat people up." WHERE name="Torg";
UPDATE button SET flavor_text="Zoë is a college co-ed, but spends most of here time trying to survive her friends' adventures. Luckily, Zoë can take care of herself and beat people up." WHERE name="Zoe";
...
UPDATE button SET flavor_text="Karl is a world champion kickboxer and a pathological liar. He likes playing drums, and beat people up." WHERE name="Karl";
...
UPDATE button SET flavor_text="Kublai is an embittered fast-food worker whose time is never his own. He likes malts, orangutangs, and beating people up." WHERE name="Kublai";
UPDATE button SET flavor_text="Niles is a three-time winner of the secret tijuana kitchen utensils freestyle, and he likes to beat peple up." WHERE name="Niles";
...
UPDATE button SET flavor_text="Angel repair vintage motorcycles and enjoys picnics by moonlight. She is a staunch advocate of women's suffrages, and she likes to beat people up." WHERE name="Angel";
UPDATE button SET flavor_text="Buddy is heartless brute without soul or conscience. It likes cabbages and howling, and it likes to beat people up." WHERE name="Buddy";
