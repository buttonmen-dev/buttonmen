...
# ('Gordo',               '(4) (12) (20) (X)!',                 0, (SELECT id FROM buttonset WHERE name="2000")),
...
('Guillermo',           '(6) (10) (20) (X) (Y)',              1, (SELECT id FROM buttonset WHERE name="2000")),
...
('The Shadow Warriors', '(1) (2) r(4) r(6) r(8) r(10) r(12)',            1, (SELECT id FROM buttonset WHERE name="Sailor Moon 1")),
...
('Buck Godot',  '(6,6) (10) (12) (20) (W,W)',    1, (SELECT id FROM buttonset WHERE name="Studio Foglio")),
...
('James Beast', '(4) (8,8) (10,10) (12) (W,W)',  0, (SELECT id FROM buttonset WHERE name="Studio Foglio")),
...
# ('The Winslow', '(30)',                          0, (SELECT id FROM buttonset WHERE name="Studio Foglio")),
