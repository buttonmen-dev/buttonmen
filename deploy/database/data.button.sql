...
# Durer Rawg (TheOrgg)
# Ashley Jay's button special: Ashley Jay's recipe is all Standard Dice that are one size smaller than her opponent's. Variable dice are copied as is. If the opponent's dice cannot be copied, Ashley Jay's recipe is four Y-Swing Dice instead.
# Orry's button special: When you are taking an extra turn, your dice lose the Boom skill. When you use a Boom Attack, take an extra turn.
# Portia's button special: Before rolling for initiative, remove one of your opponent's dice from the game this round.
INSERT INTO button (id, name, recipe, btn_special, tourn_legal, set_id) VALUES
...
UPDATE button SET flavor_text="Poly is a dragon (duh!), acts as mascot for the PolyCon gaming convention in her spare time, and beats people up." WHERE name = "Poly";
UPDATE button SET flavor_text="Adam Spam eats brains with a Brazilian brain spork, sends lots of unsolicited emails, and likes to beat people up." WHERE name = "Adam Spam";
...
UPDATE button SET flavor_text="Applejack is an honest, hard working earth pony who spends most of her time bucking apple trees on her family apple orchard. She likes her family, her pet dog Winnona, and beating people up." WHERE name="Applejack";
...
UPDATE button SET flavor_text="Parasprites are ravenous little flying creatures who possess the strange ability to reproduce quickly. While in Ponyville, they enjoyed eating everything in sight, one-pony band music, and beating people up." WHERE name="Parasprites";
