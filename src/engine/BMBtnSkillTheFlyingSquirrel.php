<?php
/**
 * BMBtnSkillTheFlyingSquirrel: Code specific to The Flying Squirrel
 *
 * @author: james
 */

/**
 * This class currently supports the special skills of The Flying Squirrel
 */
class BMBtnSkillTheFlyingSquirrel extends BMBtnSkill {
    /**
